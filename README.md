...
GIF는 **광주소프트웨어마이스터고등학교 아이디어 페스티벌**의 전체 운영 과정을 하나의 플랫폼에서 효율적으로 관리하기 위한 서비스입니다. 
기존의 수기 방식에서 벗어나, 학생(Client)의 팀 프로젝트 관리·자료 제출부터 관리자(Admin)의 양식 생성·제출 현황 추적·평가·점수 집계까지 모든 워크플로우를 통합합니다.
