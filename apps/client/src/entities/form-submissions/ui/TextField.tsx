...
export default function TextField({
  ...
  return (
    <>
      <textarea
        ref={textareaRef}
        className="min-h-20 w-full break-words border border-gray-80 rounded-[10px] p-[15px] font-medium text-gray-800 outline-none resize-none placeholder:text-gray-500"
